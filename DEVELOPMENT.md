...
```bash
git remote add encore encore://todo-list-app-4dmi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/todo-list-app-4dmi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/todo-list-app-4dmi/settings/integrations/github)
